...
const Projects = () => {
  ...
  const paolaImages = ['/images/Naturals1.jpg', '/images/paola2.png', '/images/paola3.png'];
  const dokiImages = ['/images/doki1.png', '/images/doki2.png', '/images/doki3.png'];
  const foodImages = ['/images/fareph pasta.jpg', '/images/fareph cake.jpg', '/images/fareph bowl.jpg', '/images/toast.jpg'];
