    ...
    <div className="services-page">
      ...
      <div className="services-container">
        ...
        <div className="service-card">
          <img src="/service2.jpg" alt="Web Development" className="service-image" />
        ...
        {/* Service 2 */}
        <div className="service-card">
          <img src="/service1.jpg" alt="Photography" className="service-image" />
          <h3>Photography</h3>
          <p>
        ...
        {/* Service 3 */}
        <div className="service-card">
          <img src="/service3.jpg" alt="Graphic Design" className="service-image" />
